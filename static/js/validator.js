    ...
    n.extend(n.validator, {
        ...
        prototype: {
            ...
            stopRequest: function(t, i) {
                ...
                i && 0 === this.pendingRequest && this.formSubmitted && this.form() && 0 === this.pendingRequest ? (n(this.currentForm).trigger("submit"),
        ...
        normalizeAttributeRule: function(n, t, i, r) {
            ...
            isNaN(r) && (r = void 0));
            r || 0 === r ? n[i] = r : t === i && "range" !== t && (n["date" === t ? "dateISO" : i] = !0)
        },
        ...
        methods: {
            ...
            url: function(n, t) {
                return this.optional(t) || /^(?:(?:(?:https?|ftp):)?\/\/)(?:(?:[^\]\[?\/<~#`!@$^&*()+=}|:";',>{ ]|%[0-9A-Fa-f]{2})+(?::(?:[^\]\[?\/<~#`!@$^&*()+=}|:";',>{ ]|%[0-9A-Fa-f]{2})*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z0-9\u00a1-\uffff][a-z0-9\u00a1-\uffff_-]{0,62})?[a-z0-9\u00a1-\uffff]\.)+(?:[a-z\u00a1-\uffff]{2,}\.?))(?::\d{2,5})?(?:[/?#]\S*)?$/i.test(n)
            },
            date: function() {
                var n = !1;
                return function(t, i) {
...
!function(n) {
    ...
    function o(n, t) {
        return 0 === n.indexOf("*.") ? n.replace("*.", t) : n
    }
    function h() {
        var t = n(this)
        ...
        if (!t.data(i)) {
            ...
            t.find(".field-validation-error").addClass("field-validation-valid").removeClass("field-validation-error").removeAttr("role").removeAttr("aria-live").removeData("unobtrusiveContainer").find(">*").removeData("unobtrusiveContainer")
        }
    }
    function s(t) {
        function o(i, r) {
            (i = s[i]) && n.isFunction(i) && i.apply(t, r)
        }
        var i = n(t)
          , e = i.data(u)
          , c = n.proxy(h, t)
          , s = r.unobtrusive.options || {};
        return e || (e = {
            options: {
                ...
                errorPlacement: function() {
                    !function(t, i) {
                        var i = n(this).find("[data-valmsg-for='" + f(i[0].name) + "']")
                          , r = (r = i.attr("data-valmsg-replace")) ? !1 !== n.parseJSON(r) : null;
                        i.removeClass("field-validation-valid").addClass("field-validation-error").attr("role", "alert").attr("aria-live", "polite");
                ...
                success: function() {
                    !function(t) {
                        var i, r = t.data("unobtrusiveContainer");
                        r && (i = (i = r.attr("data-valmsg-replace")) ? n.parseJSON(i) : null,
                        r.addClass("field-validation-valid").removeClass("field-validation-error").removeAttr("role").removeAttr("aria-live"),
            ...
            attachValidation: function() {
                i.off("reset." + u, c).on("reset." + u, c).validate(this.options)
            },
            validate: function() {
                return i.validate(),
                i.valid()
    ...
    return r.unobtrusive = {
        ...
        parse: function(t) {
            var t = n(t)
              , i = t.parents().addBack().filter("form").add(t.find("form")).has("[data-val=true]");
    ...
    r.addMethod("regex", function(n, t, i) {
        return !!this.optional(t) || (t = new RegExp(i).exec(n)) && 0 === t.index && t[0].length === n.length
    }),
    r.addMethod("nonalphamin", function(n, t, i) {
        var r;
        return i ? (r = n.match(/\W/g)) && r.length >= i : r
    }),
    ...
    t.add("equalto", ["other"], function(t) {
        var r = e(t.element.name)
          , r = o(t.params.other, r);
        i(t, "equalTo", n(t.form).find(":input").filter("[name='" + f(r) + "']")[0])
    }),
...
culture && culture == "fa" && function(n) {
    typeof module == "object" && module.exports ? module.exports = n(require("jquery")) : n(jQuery)
}(function(n) {
    return n.extend(n.validator.messages, {
        ...
        maxlength: n.validator.format("لطفا بیشتر از {0} کاراکتر وارد نکنید"),
        minlength: n.validator.format("لطفا کمتر از {0} کاراکتر وارد نکنید"),
        rangelength: n.validator.format("لطفا مقداری بین {0} تا {1} کاراکتر وارد کنید"),
        range: n.validator.format("لطفا مقداری بین {0} تا {1} کاراکتر وارد کنید"),
        max: n.validator.format("لطفا مقداری کمتر از {0} وارد کنید"),
        min: n.validator.format("لطفا مقداری بیشتر از {0} وارد کنید"),
        minWords: n.validator.format("لطفا حداقل {0} کاراکتر وارد کنید"),
        maxWords: n.validator.format("لطفا حداکثر {0} کاراکتر وارد کنید")
    }),
    n
})
